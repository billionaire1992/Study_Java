public class Casting03 {
	public static void main(String[] args) {
		//String 클래스 타입을 갖는 문자 10(str1)과 문자 20(str2)을 더하기 연산
		String str1 = "10";
		String str2 = "20";
		...
		//String 클래스 타입을 기본 데이터 타입(PDT)으로 변환해 주는 클래스 ▶ Wrapper Class
		...
		//String 클래스 타입을 갖는 문자 12.3(str3)과 문자 45.67(str4)을 더하기 연산
		String str3 = "12.3";
		String str4 = "45.67";
		System.out.println(str3 + str4);	//출력값 : 12.345.67
		
		double num3 = Double.parseDouble(str3);	//String → double ▶ Wrapper Class
		double num4 = Double.parseDouble(str4);	//String → double ▶ Wrapper Class
